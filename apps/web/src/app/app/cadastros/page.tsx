    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          title: "Base de Conhecimento (Agente de IA)",
          description: "Perguntas e respostas que os agentes de IA reaproveitam em conversas futuras",
          icon: BookOpen,
          href: "/app/cadastros/base-conhecimento",
          count: "Aprendizado dos Agentes",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-violet-500/10 text-violet-400 border-violet-500/20" : "bg-violet-50 text-violet-600 border-violet-200",
        },
      ],
