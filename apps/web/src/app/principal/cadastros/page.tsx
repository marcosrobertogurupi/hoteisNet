      ...
      modules: [
        {
          ...
          icon: Users,
          href: "/principal/cadastros/hospedes",
        ...
        },
        {
          ...
          icon: Building2,
          href: "/principal/cadastros/empresas",
        ...
        },
        {
          ...
          icon: Truck,
          href: "/principal/cadastros/fornecedores",
        ...
        },
        {
          ...
          icon: UserCheck,
          href: "/principal/cadastros/colaboradores",
          count: "Funcionários",
          badge: "Dados Sincronizados",
        ...
        },
        {
          id: "governantas",
          title: "Governantas",
          description: "Cadastro da equipe de limpeza com acesso ao app mobile de governança",
          icon: Sparkles,
          href: "/principal/cadastros/governantas",
          count: "App de Governança",
          badge: "Dados Sincronizados",
        ...
        },
        {
          ...
          icon: ShieldCheck,
          href: "/principal/cadastros/usuarios",
          count: "Logins / Níveis",
          badge: "Dados Sincronizados",
      ...
      modules: [
        {
          ...
          icon: BedDouble,
          href: "/principal/cadastros/apartamentos",
          count: "Mapa de UHs",
          badge: "Dados Sincronizados",
      ...
      modules: [
        {
          ...
          description: "Cadastro e manutenção de produtos: grupo, tipo, unidade, marca, preços, estoque e perfil fiscal",
          icon: Package,
          href: "/principal/cadastros/produtos",
          count: "Cadastro Mestre",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-orange-500/10 text-orange-400 border-orange-500/20" : "bg-orange-50 text-orange-600 border-orange-200",
        },
        {
          id: "estoque-multi-pdv",
          title: "Estoque por PDV",
          description: "Saldo de cada produto em cada ponto de venda, transferências e códigos de barras",
          icon: Store,
          href: "/principal/stock",
          count: "Multi-Estoque",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-orange-500/10 text-orange-400 border-orange-500/20" : "bg-orange-50 text-orange-600 border-orange-200",
        },
        {
          ...
          href: "/principal/cadastros/pratos",
          count: "Cozinha / Bar",
          badge: "Dados Sincronizados",
        ...
        },
        {
          ...
          icon: Briefcase,
          href: "/principal/cadastros/servicos",
        ...
        },
        {
          ...
          description: "Grupos de produtos, pratos e serviços — a classificação principal, escolhida de lista, nunca digitada",
          icon: Tags,
          href: "/principal/cadastros/grupos",
          count: "Agrupamento",
          badge: "Dados Sincronizados",
        ...
        },
        {
          ...
          description: "Segunda classificação do produto (Revenda, Uso e consumo, Cortesia...), independente do grupo",
          icon: Layers,
          href: "/principal/cadastros/tipos-produto",
          count: "Classificação",
          badge: "Dados Sincronizados",
        ...
        },
        {
          ...
          icon: Receipt,
          href: "/principal/cadastros/comandas",
          count: "Restaurante",
          badge: "Dados Sincronizados",
      ...
      modules: [
        {
          ...
          icon: Landmark,
          href: "/principal/cadastros/bancos",
          count: "Conciliação",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" : "bg-emerald-50 text-emerald-600 border-emerald-200",
        },
        {
          ...
          icon: CreditCard,
          href: "/principal/cadastros/formas-pagamento",
        ...
        },
        {
          ...
          icon: ReceivableIcon,
          href: "/principal/cadastros/contas-receber",
          count: "Parcelamento",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-amber-500/10 text-amber-400 border-amber-500/20" : "bg-amber-50 text-amber-600 border-amber-200",
        },
        {
          ...
          icon: Wallet,
          href: "/principal/cadastros/contas-pagar",
          count: "Financeiro",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-rose-500/10 text-rose-400 border-rose-500/20" : "bg-rose-50 text-rose-600 border-rose-200",
        },
        {
          ...
          icon: Wallet,
          href: "/principal/cadastros/saldo-hospede",
        ...
        },
        {
          ...
          icon: BookOpen,
          href: "/principal/cadastros/plano-contas",
        ...
        },
        {
          ...
          icon: Globe,
          href: "/principal/cadastros/localidades",
          count: "Tabelas IBGE",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-blue-500/10 text-blue-400 border-blue-500/20" : "bg-blue-50 text-blue-600 border-blue-200",
        },
        {
          ...
          title: "Base de Conhecimento do Hotel",
          description: "Os 12 tópicos (horários, políticas, serviços...) que o agente de atendimento consulta para responder o hóspede",
          icon: BookOpen,
          href: "/principal/cadastros/base-conhecimento",
          count: "Atendimento por IA",
          badge: "Dados Sincronizados",
          color: isDark ? "bg-violet-500/10 text-violet-400 border-violet-500/20" : "bg-violet-50 text-violet-600 border-violet-200",
        },
      ],
