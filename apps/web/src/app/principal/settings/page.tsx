...
export default function SubscriberSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    // Avisa o InactivityLock (montado no layout persistente de /principal) para recarregar o
          ...
          <div className={`space-y-4 rounded-xl border p-4 ${theme.isDark ? "border-slate-800 bg-slate-900/40" : "border-slate-200 bg-slate-50"}`}>
            ...
            <div className={`text-xs flex items-start gap-2 ${theme.textMuted}`}>
              ...
              <span>
                ...
                <Link href="/principal/cadastros/categorias-apartamento" className="font-semibold text-teal-500 hover:underline">
        ...
        <div className={`p-4 rounded-xl border flex flex-col md:flex-row gap-4 ${theme.isDark ? "bg-slate-900/60 border-slate-800" : "bg-slate-50 border-slate-200"}`}>
          ...
          <div className="flex-1 space-y-3">
            <p className={`text-[11px] ${theme.textMuted}`}>
              ...
              <Link href="/principal/cadastros/base-conhecimento" className="text-violet-500 font-semibold hover:underline">
