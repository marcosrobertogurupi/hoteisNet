            ...
            <div className="space-y-2">
              ...
              {terminais.length === 0 && (
                <p className="text-xs text-amber-500">
                  ...
                  <Link href="/principal/fiscal" className="underline">
      ...
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/principal/fiscal" className={ghostBtn(isDark)} title="Configuração fiscal & PDV">
            ...
            {!selected ? (
              ...
              <div className="space-y-4">
                ...
                {selected.itens.some((i) => !i.cancelado) && (
                  <a
                    href={`/principal/pdv/conferencia/${selected.id}`}
                    target="_blank"
                    rel="noreferrer"
