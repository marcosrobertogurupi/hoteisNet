...
* **Alerta de intervenção humana ✅** (`HumanEscalation`, `api/tenant/human-escalations`): fila
  ...
  funcional em `app/app/layout.tsx` (`HumanEscalationBell`) faz polling a cada 15s (pausado com a aba em segundo plano, ver `hooks/usePolling.ts`) e mostra badge +
